...
use ty_semantic_index::{Truthiness, imported_modules, place_table, semantic_index};
...
impl<'db> ModuleLiteralType<'db> {
    ...
    /// the current file (i.e. `ty_semantic_index::definition::ImportFromDefinitionNodeRef`).
