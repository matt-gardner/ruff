...
///
/// The primitive atoms of the formula are [`crate::predicate::Predicate`]s, which express some
...
pub const ALWAYS_TRUE: ScopedReachabilityConstraintId = ScopedReachabilityConstraintId::ALWAYS_TRUE;
pub const AMBIGUOUS: ScopedReachabilityConstraintId = ScopedReachabilityConstraintId::AMBIGUOUS;
pub const ALWAYS_FALSE: ScopedReachabilityConstraintId =
    ScopedReachabilityConstraintId::ALWAYS_FALSE;
pub const SMALLEST_TERMINAL: ScopedReachabilityConstraintId = ALWAYS_FALSE;
...
impl ReachabilityConstraintsBuilder {
    pub(super) fn build(self) -> ReachabilityConstraints {
    ...
    /// Adds a new reachability constraint that checks a single [`crate::predicate::Predicate`].
    ///
    ...
    /// advantage of the fact that the [`crate::predicate::Predicates`] arena does not deduplicate `Predicate`s.
